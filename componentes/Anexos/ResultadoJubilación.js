      ...
      headerRight: () => (
        <TouchableOpacity onPress={DiasJubilacion}>
          <Text style={styles.buttonText}>
            Quanto tempo até você se aposentar
          </Text>
        </TouchableOpacity>
      ),
    });
  ...
  return (
    <View>
      ...
      <Text style={styles.labelText}>
        Idade atual: <Text style={styles.resultText}>{edadActual} años</Text>
      </Text>
      <Text style={styles.labelText}>
        Idade de aposentadoira:{" "}
        <Text style={styles.resultText}>{edadJubilacion} años</Text>
      </Text>
      <Text style={styles.labelText}>
        Poupança atual: <Text style={styles.resultText}>{montoActual} </Text>
      </Text>
      <Text style={styles.labelText}>
        Taxa de juros anual:{" "}
      ...
      <Text style={styles.labelText}>
        {" "}
        O valor estimado para a aposentadoria é:{" "}
