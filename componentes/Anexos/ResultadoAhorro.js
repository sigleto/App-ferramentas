...
export default function ResultadoAhorro({ route }) {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.labelText}>Meta de poupança: <Text style={styles.resultText}>{meta}</Text></Text>
      ...
      <Text style={styles.labelText}>Poupança mensal necessária: <Text style={styles.resultText}>{parseFloat(ahorroNecesario).toFixed(2)}</Text></Text>
      {ahorroNecesario ? (
        <View>
          <LineChart
            data={data}
